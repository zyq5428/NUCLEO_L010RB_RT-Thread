 ...
 * Change Logs:
 * Date           Author       Notes
 * 2023-03-04     RealThread   first version
 */
...
#define CHIP_NAME_STM32L010RBTX
...
#define BSP_GREEN_LED_PIN       GET_PIN(A, 5)
#define BSP_BLUE_BOTTON_PIN     GET_PIN(C, 13)
...
#define BSP_I2C1_SDA_PIN    GET_PIN(C, 6)
#endif
